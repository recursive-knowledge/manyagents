"""M2 offline tests for oma.bank — retry, idempotent put, FakeBank round-trip,
atomic next_agent_seq, reuse_score, quarantine, migration integrity
(oma.bank.md Verification; security/RLS matrix is the gated integration suite).
"""
...
from oma.bank import FakeBank, make_cursor, with_backoff
