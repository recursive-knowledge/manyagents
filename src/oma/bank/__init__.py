"""oma.bank — the Knowledge Bank: Supabase client, 4-identity access, the
...
from oma.bank.base import Bank, Identity
from oma.bank.fake import FakeBank, make_cursor
from oma.bank.retry import with_backoff

# Per-identity singletons: a stable instance (hence stable ``cache_key``) so
# oma.core's hydration cache stays coherent across get_bank() calls.
