...
DB-enforced and covered by the gated integration suite (oma.bank.md
...
class FakeBank:
    """A dict-backed async :class:`~oma.bank.base.Bank`."""

    def __init__(self) -> None:
        # Per-instance identity so oma.core's hydration cache never confuses
...
def make_cursor(row: dict[str, Any]) -> str:
    """Opaque pagination cursor: ``created_at|id`` (oma.web M9 reuses this)."""
