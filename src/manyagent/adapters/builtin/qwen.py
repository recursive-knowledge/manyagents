"""``qwen`` — first-party **stub** (manyagent.adapters.md "builtin").
...
its operations raise :class:`~manyagent.adapters.base.NotInstalled` until a real
...
from manyagent.adapters.base import Adapter, NotInstalled, PromptPrefixInjector, RawTrace
