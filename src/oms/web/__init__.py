"""oms.web — read-only FastAPI surface + static viewer (M9).
...
app-enforced; the anon API can never return a raw trace body (oms.web.md).
"""

from __future__ import annotations

from oms.web.api import create_app
from oms.web.server import build_app, serve
