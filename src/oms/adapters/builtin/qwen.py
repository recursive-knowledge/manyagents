"""``qwen`` — first-party **stub** (oms.adapters.md "builtin").
...
its operations raise :class:`~oms.adapters.base.NotInstalled` until a real
...
from oms.adapters.base import Adapter, NotInstalled, PromptPrefixInjector, RawTrace
