"""oms.forum — the write-time contribution discipline (M6; oms.forum.md).
...
(``oms.distill``, M7) consumes posts and imports **this module's**
...
``/self-distill`` post is not stored — the CLI re-prompts (oms.forum.md:89).
"""
...
from oms.forum.parser import parse_post
from oms.forum.prompt import render_post_prompt
from oms.forum.schema import REQUIRED_FIELDS, validate_schema
