...
DB-enforced and covered by the gated integration suite (oms.bank.md
...
class FakeBank:
    """A dict-backed async :class:`~oms.bank.base.Bank`."""

    def __init__(self) -> None:
        # Per-instance identity so oms.core's hydration cache never confuses
...
def make_cursor(row: dict[str, Any]) -> str:
    """Opaque pagination cursor: ``created_at|id`` (oms.web M9 reuses this)."""
